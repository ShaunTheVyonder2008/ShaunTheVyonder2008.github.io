...
function NavigationReact(props) {
  ...
  const navLinks = [
    { href: "//status.ttnrtsite.me", linkText: "Status", target: "" },
    { href: "//forums.ttnrtstie.me", linkText: "Forums", target: "" },
    { href: "//www.ttnrtsite.me", linkText: "Main site", target: "" },
  ];
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 border-b-2 z-50 filter bg-white bg-opacity-90 backdrop-blur-xl ">
      <div className="flex max-w-screen-xl mx-auto h-14 px-4 xl:px-0 items-center">
        <div className="flex-1">
          <a className="flex w-fit items-center gap-1 lg:gap-2" href="/">
            <img
              ...
              src="//cdn.ttnrtsite.me/images/logo.png"
            />
        ...
        <div className="lg:flex-5 justify-center hidden gap-4 sm:flex">
